...
const jobNodes = [
    { id: 1, role: "Software Engineer", stack: "React, Node.js, Python", salary: "$110k+", color: "#3b82f6", r: 280, deg: 300, icon: Code2 }, // Blue
    { id: 2, role: "Data Analyst", stack: "SQL, Tableau, R", salary: "$95k+", color: "#10b981", r: 200, deg: 220, icon: Database }, // Green
    { id: 3, role: "DevOps Engineer", stack: "AWS, Docker, CI/CD", salary: "$125k+", color: "#f59e0b", r: 280, deg: 180, icon: Cloud }, // Orange
    { id: 4, role: "UX Engineer", stack: "Figma, CSS, Accessibility", salary: "$105k+", color: "#8b5cf6", r: 120, deg: 260, icon: Layout }, // Purple
];

export default function CareerMilestonesHero2() {
    ...
    return (
        <section className="relative bg-white min-h-screen py-24 overflow-hidden flex flex-col justify-center">
            ...
            <div className="absolute inset-0 pointer-events-none z-0">
                ...
                <div className="absolute left-[1050px] top-[280px] w-0 h-0 overflow-visible pointer-events-auto">
                    {jobNodes.map((job) => {
            ...
            */}
                    <div className="relative w-full h-24 mb-10 max-w-3xl">
