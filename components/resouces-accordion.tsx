                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="p-5 flex items-center gap-4">
                                        <div className={`p-3 rounded-xl transition-colors duration-300 ${isActive ? 'bg-[#7abde8] text-white' : 'bg-slate-200 text-slate-500'
                                            }`}>
                                        ...
                                        <div className="px-5 pb-6 pt-0">
                                            {isActive && feature.content ? (
                                                ...
                                                <>
                                                    ...
                                                    <button className="text-sm font-bold text-[#7abde8] flex items-center gap-2 hover:gap-3 transition-all">
                                    ...
                                    {isActive && (
                                        <motion.div
                                            ...
                                            className="absolute left-0 top-0 bottom-0 w-1 bg-[#7abde8]"
                                        />
                                    )}
                                </div>
                            );
