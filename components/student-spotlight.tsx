...
const spotlights = [
    {
        ...
        description: "Our talented team of computer science students took home the grand prize, showcasing innovation and technical excellence on a national stage."
    },
    {
        id: 'game-jam',
    ...
    {
        id: 'eric-benedetto',
        title: "For Eric Benedetto, Remote Learning Was Perfect For Pot-Bellied Pigs",
    ...
    {
        id: 'developforgood',
        title: "CS Students Mohammed Othman & Ramiz Faragalla Highlighted in Developforgood Newsletter",
        category: "Career Success",
        icon: Briefcase,
        date: "Summer 2021",
        description: "Mohammed Othman (Class of 2021), Mobile Developer at Invonto, and Ramiz Faragalla, Intern at Success Factors, are featured in the summer newsletter for Developforgood."
    },
    {
        id: 'omar-barragan',
        title: "Omar Barragan CS Graduate Featured in NY Jobs CEO Council Annual Report",
        category: "Alumni Story",
        icon: GraduationCap,
        date: "2021",
        description: "Omar Barragan, CS graduate, is featured on the New York Jobs CEO Council's 2021 Annual Report (page 12)."
    },
    {
        id: 'codepath-club',
        title: "CodePath Club Provides New Grounds for Computer Science Student Exploration",
        category: "Event",
        icon: Code2,
        date: "2023"
    },
