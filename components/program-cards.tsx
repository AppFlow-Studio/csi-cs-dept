...
export default function AASProgramSection() {
  ...
  const programData = {
    ...
    links: [
      { label: "Sample 2-Year Plan", href: "#", type: "pdf" as const },
      { label: "Prerequisite Flowchart", href: "#", type: "flowchart" as const },
      { label: "Degree Requirements", href: "#", type: "link" as const },
      { label: "Checklist: Programming Seq", href: "#", type: "checklist" as const },
      { label: "Checklist: Info Science Seq", href: "#", type: "checklist" as const },
    ]
  };
...
export function BSComputerScienceSection() {
  const programData = {
    ...
    links: [
      { label: "Sample 4-year Degree/Career Map", href: "#", type: "pdf" as const },
      { label: "Video", href: "#", type: "video" as const },
      { label: "Prerequisite Flowchart", href: "#", type: "flowchart" as const },
      { label: "Degree Requirements", href: "#", type: "link" as const },
      { label: "Degree checklist (2023-2024 major catalog)", href: "#", type: "checklist" as const },
      { label: "Degree checklist (2021-2023 major catalog)", href: "#", type: "checklist" as const },
    ]
  };
...
export function AdditionalDegreesPage() {
  ...
  const mathCSData = {
    ...
    links: [
      { label: "Degree Checklist", href: "#", type: "checklist" as const },
      { label: "Degree Requirements", href: "#", type: "link" as const },
    ]
  };
  ...
  const isiData = {
    ...
    links: [
      { label: "Sample 4-Year Plan", href: "#", type: "pdf" as const },
      { label: "Prerequisite Flowchart", href: "#", type: "flowchart" as const },
      { label: "Degree Requirements", href: "#", type: "link" as const },
    ]
  };
  ...
  return (
    <div className=" min-h-screen">
      ...
      {/* Second Card: ISI (Reversed Layout for visual variety) */}
